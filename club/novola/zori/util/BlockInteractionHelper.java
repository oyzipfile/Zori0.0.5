...
public class BlockInteractionHelper
{
    ...
    public static boolean placeBlockScaffold(final BlockPos pos) {
        ...
        for (final EnumFacing side : EnumFacing.values()) {
            ...
            if (canBeClicked(neighbor)) {
                final Vec3d hitVector = getHitVector(neighbor, side2);
    ...
    private static Vec3d getHitVector(final BlockPos pos, final EnumFacing side2) {
        return new Vec3d((Vec3i)pos).add(0.5, 0.5, 0.5).add(new Vec3d(side2.getDirectionVec()).scale(0.5));
    }
